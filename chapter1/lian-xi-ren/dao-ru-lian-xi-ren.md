...
点击“导入联系人”按钮，首先下载联系人导入模板，录入数据到导入模板中，并选择该文件，上传完成后点击“开始导入”，系统即开始自动导入数据。系统会根据客户名称将联系人录入到相应的客户下。![](/assets/lix导入联系人.png)![](/assets/导入联系人03.png)联系人导入模板根据设置中心—自定义业务字段的设置自动生成，包括自定义业务字段中所有启用的字段。
